...
\note{Note sur la séquence de lecture: }{ Comme les méthodes de commande optimale s'applique à une classe de systèmes plus large, incluant les véhicules, ce sujet est reporté à un chapitre ultérieur après ceux qui introduisent les véhicules.}
