...
\begin{definition}{Transformation efforts articulaires $\leftrightarrow$ efforts à l'effecteur}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{align}
...
%%%%%%%%%%%%%%%%
\begin{definition}{Relation statique avec forces conservatrices}{}
\begin{align}
