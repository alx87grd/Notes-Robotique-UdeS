...
% Le reste du chapitre commence ici...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{definition}{Coordonnées cartésiennes dans un repère}{}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{definition}{Matrice de transformation}{}
\begin{align}
{}^AT^B &= 
\left[ \begin{array}{c c } 
^aR^b & \col{r}_{B_o/A_o}^a \\ 0 \; 0 \; 0 & 1
...
%%%%%%%%%%%%%%%%%%%
\begin{definition}{Matrice de transformation avec les paramètres DH}{}
\begin{align}
{}^AT^{B}(d,\theta,r,\alpha) &=
\left[ \begin{array}{c c c c }
