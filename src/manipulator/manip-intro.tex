...
\begin{equation}
\text{directe:}  \quad \col{r} = f\left( \, \col{q} \, \right)  \quad  \text{inverse:} \quad \col{q} = f^{-1}\left( \, \col{r}  \, \right) 
\end{equation}
\end{definition}
%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%
\begin{definition}{Cinématique différentielle}{}
\begin{equation}
\text{directe:} \quad \col{\dot{r}} = J\left( \, \col{q} \, \right) \, \col{\dot{q}}   \quad \text{inverse:} \quad \col{\dot{q}} = J^{\#}\left( \, \col{q} \, \right) \, \col{\dot{r}}
\end{equation}
\end{definition}
%%%%%%%%%%%%%%%
...
\begin{equation}
\col{\tau} = J^T\left( \, \col{q} \, \right) \, \col{f}_{E}   
\end{equation}
\end{definition}
%%%%%%%%%%%%%%%
...
\begin{align}
H(\col{q}) \col{\ddot{q}} + C(\col{q},\col{\dot{q}}) \col{\dot{q}} + D \col{\dot{q}} + \col{g}(\col{q}) = \col{\tau} - J^T(\col{q}) \, \col{f}_{E}   
