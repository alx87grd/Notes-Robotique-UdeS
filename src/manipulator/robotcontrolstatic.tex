...
\video{Commande en impédance et admittance}{https://youtu.be/h_3qngSmwPo}
...
\end{align}
%%%%%%%%%%%%%%%%%
En utilisant comme fonction candidate de \textit{Lyapunov} (voir détails au chapitre \ref{chap:stability}) l'énergie mécanique réelle plus l'énergie potentielle virtuelle dans le ressort du contrôleur:
%%%%%%%%%%%%%%%%%%
\begin{align}
V = 
\underbrace{
