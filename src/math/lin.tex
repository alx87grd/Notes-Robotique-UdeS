...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.60\textwidth]{calculmatriciel.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Combinaison de vecteur-colonnes}
...
\begin{example}[Utilisation d'un matrice pseudo-inverse]
