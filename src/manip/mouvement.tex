...
L'ellipsoïde de vitesse d'un robot manipulateur est l'enveloppe de vecteur vitesse possible à l'effecteur pour un vecteur de vitesse des joints unitaires:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[H]
	\centering
